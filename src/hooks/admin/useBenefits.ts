...
import { listBenefits, deleteBenefit, toggleBenefit } from '../../lib/admin/benefits';
...
export function useBenefits(): UseBenefitsReturn {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await listBenefits({ page, pageSize, search, sortColumn, sortDirection });
      setData(result.data);
