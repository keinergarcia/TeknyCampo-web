...
import { listEntities, deleteEntity, toggleEntity } from '../../lib/admin/entities';
...
export function useEntities(): UseEntitiesReturn {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await listEntities({ page, pageSize, search, sortColumn, sortDirection });
      setData(result.data);
