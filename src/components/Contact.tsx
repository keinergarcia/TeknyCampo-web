...
const contactInfo = [
  { icon: MapPin, title: 'Ubicación', value: CONTACT.address, detail: CONTACT.department },
  { icon: Phone, title: 'Teléfono', value: CONTACT.phone, detail: 'WhatsApp disponible' },
  { icon: Mail, title: 'Correo', value: CONTACT.email, detail: CONTACT.responseTime },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Ponte en contacto con nosotros. Nuestro equipo está listo para atender tus consultas.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="mt-6 rounded-2xl overflow-hidden border border-slate-200 h-48 sm:h-64">
              <iframe
                ...
                title="Ubicación COOPROMU en La Playa de Belén"
              />
            </div>
          </motion.div>
